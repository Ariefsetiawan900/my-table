...
function Table({
  ...
  return (
    <>
      <table
        {...getTableProps()}
        className={` table table-bordered table-striped ${classnames({
      ...
      >
        <thead
          className={`${classnames({
            'thead-dark text-center': tableDark,
            'bg-success text-center text-white': tableGreen,
            'bg-info text-white text-center': tableBlue,
          })}`}
        >
        ...
        <tbody {...getTableBodyProps()}>
          {page.map((row) => {
            ...
            return (
              <tr
                {...row.getRowProps()}
                className={`${classnames({ 'text-center': isCenter })}`}
              >
...
export const ReactTableWithPaginationCard = ({ match }) => {
        ...
        Cell: (props) => (
          <>
            <button
              ...
              onClick={() => setModalEditTop(true)}
            >
              <li
                className="glyph-icon simple-icon-note"
            ...
            <button
              ...
              onClick={() => setModalDeleteTop(true)}
            >
              <li
  ...
  return (
    <>
      ...
      <div>
        <Modal isOpen={modalAddTop} toggle={() => setModalAddTop(!modalAddTop)}>
          <ModalHeader>
            <h5>Add Data</h5>
          </ModalHeader>
          <Form>
            ...
            <ModalFooter>
              <Button color="success" onClick={() => setModalAddTop(false)}>
                Save
              </Button>{' '}
              <Button color="light" onClick={() => setModalAddTop(false)}>
                Cancel
              </Button>
            </ModalFooter>
          </Form>
      ...
      <div>
        ...
        >
          ...
          <Form>
            ...
            <ModalFooter>
              <Button color="success" onClick={() => setModalEditTop(false)}>
                Save
              </Button>{' '}
              <Button color="light" onClick={() => setModalEditTop(false)}>
                Cancel
              </Button>
            </ModalFooter>
          </Form>
      ...
      <div>
        ...
        >
          ...
          <ModalFooter>
            <Button color="danger" onClick={() => setModalDeleteTop(false)}>
              Delete
            </Button>{' '}
            <Button color="light" onClick={() => setModalDeleteTop(false)}>
              Cancel
            </Button>
          </ModalFooter>
        </Modal>
      ...
      },
      {
        ...
        Cell: (props) => (
          <>
            <button
              className="btn btn-secondary"
              onClick={() => setModalUpdateCenter(true)}
            >
              <li
                className="glyph-icon simple-icon-note"
                style={{ listStyleType: 'none' }}
            ...
            <button
              className="btn btn-danger"
              onClick={() => setModalDeleteCenter(true)}
            >
              <li
                className="glyph-icon simple-icon-trash"
                style={{ listStyleType: 'none' }}
  ...
  return (
    <>
      <Card className="mb-5">
        <CardBody>
          <CardTitle>
            <h5 className="mb-3">Data Absensi</h5>
            <Separator className="mb-5" />
            <CSVLink
              data={user}
              headers={header}
            ...
            <button
              className="btn btn-secondary"
              onClick={() => setModalAddCenter(true)}
            >
              <li
                className="glyph-icon simple-icon-plus"
                style={{ listStyleType: 'none' }}
      ...
      <div>
        ...
        >
          ...
          <ModalBody>Apakah anda yakin menghapus data ini?</ModalBody>
          <ModalFooter>
            <Button color="danger" onClick={() => setModalDeleteCenter(false)}>
              Delete
            </Button>{' '}
            <Button color="light" onClick={() => setModalDeleteCenter(false)}>
              Cancel
            </Button>
          </ModalFooter>
        </Modal>
        ...
        >
          ...
          <Form>
            ...
            <ModalFooter>
              ...
              <Button color="light" onClick={() => setModalUpdateCenter(false)}>
                Cancel
              </Button>
            </ModalFooter>
          </Form>
      ...
      <div>
        ...
        >
          ...
          <Form>
            ...
            <ModalFooter>
              <Button color="success" onClick={() => setModalAddCenter(false)}>
                Save
              </Button>{' '}
              <Button color="light" onClick={() => setModalAddCenter(false)}>
                Cancel
              </Button>
            </ModalFooter>
          </Form>
